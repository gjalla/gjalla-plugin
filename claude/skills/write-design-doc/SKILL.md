...
description: >
  Write a technical design document (RFC, tech spec, design doc, or plan) before implementing a feature
  or system change. Use this skill whenever the task involves building something non-trivial —
  a new service, a significant refactor, a new API, a data model change, or any work that touches
  multiple components or teams.
---

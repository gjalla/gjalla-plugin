...
description: >
  Add production-grade observability to code — structured logging, metrics, tracing, alerting,
  etc. Use this skill when the user is building or modifying a service that runs in prod.
  Triggers on phrases like "how will we know if this breaks", "production ready", or mentions of
  observability/metrics/etc. If you're building a new service, this skill should trigger.
---
